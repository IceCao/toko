                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-12 mb-2">
                                    <small class="text-danger">Note* Isi password dan confirm password jika ingin mengganti password</small>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <?php echo form_label("Nama Lengkap", 'nama_user', array('class' => 'control-label')); ?>
                                        <input id='nama_user' class='form-control' type='text' name='nama_user' value="<?php echo set_value('nama_user', isset($users->nama_user) ? $users->nama_user : ''); ?>" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input id='username' class='form-control' type='text' name='username' value="<?php echo set_value('username', isset($users->username) ? $users->username : ''); ?>" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input id='role' class='form-control' type='text' name='role' readonly value="<?php echo set_value('role', isset($users->role) ? $users->role : ''); ?>">
                                    </div>
                                </div>
                                <div class="col-md-12">
